...
-- This fixes the profit tracking in the unified transaction functions

-- Step 1: Update the unified transaction functions to include profit tracking
...
-- Step 2: Recreate create_sale_transaction with proper profit tracking
...
-- Step 3: Recreate bulk transaction function with profit tracking
...
-- Step 5: Verify profit tracking is working
SELECT 'Profit calculation fix completed!' as status,
       'Cash sales now record immediate profit in profit_tracking table' as details,
       'Loan sales defer profit until fully paid' as loan_profit_logic;

-- Step 6: Test profit calculation function
SELECT 
    'Test profit calculation' as test,
    calculate_standard_profit(50.00, 30.00, 5) as expected_profit;
