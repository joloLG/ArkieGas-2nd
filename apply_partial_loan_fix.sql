...
-- This will fix Partial Loan to work exactly like Full Loan
...
-- Step 2: Create corrected create_partial_loan function
...
-- Step 3: Create updated create_transaction_v2 function
...
-- Step 4: Create updated process_loan_payment_v2 function
...
BEGIN
  ...
  excess_amount := GREATEST(0, -remaining_balance);
...
-- Step 5: Clean up existing incorrect profit records for partial loans
...
-- Success message
SELECT 'Partial Loan profit calculations have been fixed to match Full Loan behavior!' as status;
